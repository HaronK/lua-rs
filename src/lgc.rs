            ...
            luaM_realloc_(
                ...
                (::std::mem::size_of::<CClosure>() as libc::c_ulong as libc::c_int
                    + (::std::mem::size_of::<TValue>() as libc::c_ulong).wrapping_mul(
                        ((*(o as *mut GCUnion)).cl.c.nupvalues as libc::c_int - 1i32)
                            as libc::c_ulong,
        ...
        4 => {
            ...
            luaM_realloc_(
                ...
                (::std::mem::size_of::<UTString>() as libc::c_ulong).wrapping_add(
                    (((*(o as *mut GCUnion)).ts.shrlen as libc::c_int + 1i32) as libc::c_ulong)
    ...
    luaM_realloc_(
        ...
        (::std::mem::size_of::<LClosure>() as libc::c_ulong as libc::c_int
            + (::std::mem::size_of::<*mut TValue>() as libc::c_ulong)
                .wrapping_mul(((*cl).nupvalues as libc::c_int - 1i32) as libc::c_ulong)
                as libc::c_int) as size_t,
        0i32 as size_t,
    );
}
...
unsafe extern "C" fn iscleared(mut g: *mut global_State, mut o: *const TValue) -> libc::c_int {
    if 0 == (*o).tt_ & 1i32 << 6i32 {
        ...
        if 0 != (*((*o).value_.gc as *mut GCUnion)).ts.marked as libc::c_int
            & (1i32 << 0i32 | 1i32 << 1i32)
        {
            reallymarkobject(
                g,
        ...
        match (*o).tt as libc::c_int {
            ...
            7 => {
                ...
                if !(*(o as *mut GCUnion)).u.metatable.is_null() {
                    if 0 != (*(*(o as *mut GCUnion)).u.metatable).marked as libc::c_int
                        & (1i32 << 0i32 | 1i32 << 1i32)
                    {
                        reallymarkobject(
                            g,
                ...
                if !(0 != uvalue.tt_ & 1i32 << 6i32
                    && 0 != (*uvalue.value_.gc).marked as libc::c_int
                        & (1i32 << 0i32 | 1i32 << 1i32))
                {
                    break;
                }
...
unsafe extern "C" fn traverseproto(mut g: *mut global_State, mut f: *mut Proto) -> libc::c_int {
    ...
    return (::std::mem::size_of::<Proto>() as libc::c_ulong)
        .wrapping_add(
...
unsafe extern "C" fn traversethread(mut g: *mut global_State, mut th: *mut lua_State) -> lu_mem {
    ...
    if o.is_null() {
        ...
        return (::std::mem::size_of::<lua_State>() as libc::c_ulong)
            .wrapping_add(
                (::std::mem::size_of::<TValue>() as libc::c_ulong)
...
unsafe extern "C" fn traverseCclosure(mut g: *mut global_State, mut cl: *mut CClosure) -> lu_mem {
    ...
    while i < (*cl).nupvalues as libc::c_int {
        if 0 != (*cl).upvalue[i as usize].tt_ & 1i32 << 6i32
            && 0 != (*(*cl).upvalue[i as usize].value_.gc).marked as libc::c_int
                & (1i32 << 0i32 | 1i32 << 1i32)
        {
    ...
    return (::std::mem::size_of::<CClosure>() as libc::c_ulong as libc::c_int
        + (::std::mem::size_of::<TValue>() as libc::c_ulong)
            .wrapping_mul(((*cl).nupvalues as libc::c_int - 1i32) as libc::c_ulong)
...
unsafe extern "C" fn traverseLclosure(mut g: *mut global_State, mut cl: *mut LClosure) -> lu_mem {
    ...
    return (::std::mem::size_of::<LClosure>() as libc::c_ulong as libc::c_int
        + (::std::mem::size_of::<*mut TValue>() as libc::c_ulong)
            .wrapping_mul(((*cl).nupvalues as libc::c_int - 1i32) as libc::c_ulong)
            as libc::c_int) as lu_mem;
}
unsafe extern "C" fn traversetable(mut g: *mut global_State, mut h: *mut Table) -> lu_mem {
    ...
    if !mode.is_null() && (*mode).tt_ & 0xfi32 == 4i32 && {
        weakkey = strchr(
            (&mut (*((*mode).value_.gc as *mut GCUnion)).ts as *mut TString as *mut libc::c_char)
                .offset(::std::mem::size_of::<UTString>() as libc::c_ulong as isize),
            'k' as i32,
        );
        weakvalue = strchr(
    ...
    return (::std::mem::size_of::<Table>() as libc::c_ulong)
        .wrapping_add(
            (::std::mem::size_of::<TValue>() as libc::c_ulong)
...
** (in the atomic phase).
*/
unsafe extern "C" fn traverseephemeron(mut g: *mut global_State, mut h: *mut Table) -> libc::c_int {
